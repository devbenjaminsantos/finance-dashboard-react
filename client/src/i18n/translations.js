...
export const translations = {
  "pt-BR": {
    ...
    pages: {
      ...
      dashboardUnassignedAccount: "Movimentacoes sem conta vinculada",
    ...
    dashboard: {
      goalsTitle: "Metas de orcamento",
      goalsSubtitle:
        "Trabalhe o orcamento geral e, quando fizer sentido, distribua limites por categoria para acompanhar onde o mes realmente esta apertando.",
      previousMonth: "Mes anterior",
      nextMonth: "Proximo mes",
      backToCurrentMonth: "Voltar ao mes atual",
      focusMonth: "Mes em foco",
      summarySpentMonth: "Despesas no mes",
      summarySpentMonthHelp: "Base usada para medir o avanco das metas.",
      summaryGoalCategories: "Categorias com meta",
      summaryGoalCategoriesHelp: "Categorias com limite especifico configurado.",
      summaryWithoutGoal: "Categorias sem meta",
      summaryWithoutGoalHelp: "Categorias com gasto no mes e ainda sem limite proprio.",
      summaryGoalsAtRisk: "Metas em risco",
      summaryGoalsAtRiskHelp: "Categorias ja estouradas ou no limite do valor definido.",
      suggestionsTitle: "Categorias que merecem meta propria",
      suggestionsSubtitle:
        "Estas categorias ja estao pesando em {{month}} e ainda nao tem meta especifica.",
      goalOverallBudgetMonth: "Orcamento geral do mes",
      goalAmountLabel: "Valor da meta",
      goalAmountPlaceholder: "Ex.: 1500,00",
      goalSaving: "Salvando...",
      goalSaveButton: "Salvar meta",
      goalAddButton: "Adicionar meta",
      goalsLoading: "Carregando metas do mes...",
      goalsLoadError: "Nao foi possivel carregar as metas do mes.",
      goalValidationAmount: "Informe um valor de meta valido.",
      goalCreated: "Meta adicionada com sucesso.",
      goalUpdated: "Meta atualizada com sucesso.",
      goalSaveError: "Nao foi possivel salvar a meta.",
      goalDeleteConfirm: "Remover esta meta mensal?",
      goalDeleted: "Meta removida com sucesso.",
      goalDeleteError: "Nao foi possivel remover a meta.",
      overviewTitle: "Visao geral do mes",
      overviewSubtitle:
        "A meta geral ajuda a entender se o conjunto das despesas esta no ritmo esperado.",
      overviewEmptyTitle: "Ainda nao ha meta geral para {{month}}",
      overviewEmptySubtitle:
        "Se quiser uma leitura mais ampla do mes, comece criando um orcamento geral antes de detalhar as categorias.",
      categoryGoalsTitle: "Metas por categoria",
      categoryGoalsSubtitle:
        "Aqui e onde a analise fica mais precisa: cada categoria mostra o quanto ja consumiu e quanto ainda resta.",
      categoryGoalsConfigured: "{{count}} configurada(s)",
      categoryGoalsEmptyTitle: "Nenhuma meta por categoria neste mes",
      categoryGoalsEmptySubtitle:
        "Crie metas para as categorias mais relevantes e acompanhe onde o orcamento aperta com mais clareza.",
      goalStatusExceeded: "Meta ultrapassada",
      goalStatusWarning: "Atencao ao limite",
      goalStatusSafe: "Dentro do planejado",
      goalOverallBudget: "Orcamento geral",
      goalDelete: "Excluir",
      goalCurrentSpent: "Gasto atual",
      goalTarget: "Meta",
      goalAvailableBalance: "Saldo disponivel",
      goalOverage: "Excedente",
      goalProgressConsumed: "{{percent}}% da meta consumida neste mes.",
      goalOtherCategory: "Outros",
      allPeriodsLabel: "Todos os periodos",
      allExpensesRecorded: "Todas as despesas registradas",
      expensesByCategory: "Despesas por categoria",
      noExpensesInPeriod: "Sem despesas registradas no periodo selecionado.",
      incomeVsExpense: "Receitas vs despesas",
      chartFootnote: "Valores em BRL com base nas transacoes salvas no periodo selecionado.",
      noMovementComparison:
        "Sem movimentacoes suficientes para exibir o comparativo do periodo selecionado.",
    },
    transactions: {
