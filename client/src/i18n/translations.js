...
export const translations = {
  "pt-BR": {
    common: {
      ...
      yes: "Sim",
      no: "Não",
      requestTimeout: "O serviço demorou para responder. Aguarde um momento e tente novamente.",
      requestAborted: "Solicitação cancelada.",
      requestOutcomeUnknown: "Não foi possível confirmar o resultado da solicitação. Confira se ela foi concluída antes de tentar novamente.",
  ...
  "en-US": {
    common: {
      ...
      yes: "Yes",
      no: "No",
      requestTimeout: "The service took too long to respond. Please wait a moment and try again.",
      requestAborted: "Request canceled.",
      requestOutcomeUnknown: "We could not confirm the result of your request. Check whether it completed before trying again.",
