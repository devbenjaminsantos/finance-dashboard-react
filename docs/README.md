...
- [Runbook de produção](production-runbook.md): arquitetura ativa Vercel, Railway, Neon e Brevo; deploy, migrations, smoke e rollback.
- [Roadmap de transição Héstia](HESTIA_TRANSITION_ROADMAP.md): rebranding técnico, cutover concluído e limites de rollback históricos.
- [Decisão e roadmap de e-mail](EMAIL_DELIVERY_ROADMAP.md): Brevo como provedor principal, entrega validada, hardening de domínio e webhooks pendentes.
